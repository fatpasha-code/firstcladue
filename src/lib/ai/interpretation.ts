...
clarification_questions: вопросы которые помогут менеджеру принять следующее решение. Максимум 3. Каждый вопрос должен опираться на конкретную ситуацию из разговора — не задавай вопросы про процессы или роли которые не обсуждались.
