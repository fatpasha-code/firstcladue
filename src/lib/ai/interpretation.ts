...
hidden_blockers: зависимости и риски которые есть в тексте, но команда не назвала их блокерами явно. Максимум 3. Каждый должен иметь опору в тексте. Приоритет — риски которые ломают движение вперёд, а не абстрактный техдолг.
