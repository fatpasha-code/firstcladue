...
management_view: что менеджеру нужно знать или сделать прямо сейчас. Конкретно. Без воды. Калибруй по реальному уровню разговора. Не усиливай формализацию: если в разговоре не было акцента на "зафиксировать письменно", "ввести процесс", "назначить ответственного" — не добавляй это сам.
...
hidden_blockers: зависимости и риски которые есть в тексте, но команда не назвала их блокерами явно. Максимум 3. Приоритет — риски которые ломают движение вперёд в ближайшие дни, а не долгосрочный техдолг или ухудшение качества в будущем. Если есть выбор между операционным риском релиза и абстрактной проблемой качества — выбирай операционный.
...
clarification_questions: вопросы которые помогут менеджеру принять следующее решение. Максимум 3. Приоритет — самые прямые незакрытые вопросы из разговора, а не методологические или продуктовые вопросы которые ты считаешь важными. Спрашивай про то, что команда реально обсуждала и не закрыла, а не про то, что стоило бы обсудить.
